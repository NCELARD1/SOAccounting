...
sap.ui.define([
		...
		return BaseController.extend("com.nico.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.nico.view.ViewSettingsDialog", this);
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						...
						case "Filter2" :
							...
							break;
						case "Filter3" :
							aFilters.push(new Filter("RECORDEDDAYSCORRECTED", FilterOperator.LE, 1000));
							break;
						case "Filter4" :
							aFilters.push(new Filter("RECORDEDDAYSCORRECTED", FilterOperator.GT, 1000));
							break;							
						default :
							break;
					}
