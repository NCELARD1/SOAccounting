sap.ui.define([
	...
	return BaseObject.extend("com.nico.model.GroupSortState", {
		 ...
		 * @alias com.nico.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CustomerName, or by CustomerID
		 *
		...
		/**
		 * Groups by CustomerID, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
