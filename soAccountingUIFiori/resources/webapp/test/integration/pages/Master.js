							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("CRM_CustomerList", {
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "CRM_CustomerList (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'CRM_CustomerList (0)'");
							},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all CRM_CustomerList to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "CRM_CustomerList (" + iExpectedLength + ")"}),
									success : function () {
