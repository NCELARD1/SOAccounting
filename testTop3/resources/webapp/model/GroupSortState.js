sap.ui.define([
	...
	return BaseObject.extend("myns.model.GroupSortState", {
		 ...
		 * @alias myns.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "ContractID");
			}
