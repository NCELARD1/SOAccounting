...
sap.ui.define([
		...
		return BaseController.extend("myns.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("ContractID", FilterOperator.Contains, sQuery)];
				} else {
